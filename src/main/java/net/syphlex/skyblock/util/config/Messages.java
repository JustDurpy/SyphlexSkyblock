...
public enum Messages {
    ...
    LEFT_ISLAND_BROADCAST("&c[!] %player% has left the island."),
    ...
    VISITOR_KICKED_FROM_ISLAND("&cYou were kicked from %player%'s island."),
    ...
    ISLAND_MEMBER_GOT_PROMOTED("&aYou have been promoted to %role% in your island."),
    PROMOTED_ISLAND_MEMBER("&aYou have promoted %player% to %role%."),
    PROMOTED_ISLAND_MEMBER_BROADCAST("&a[!] %player% was promoted to %role% by %leader%."),
    ISLAND_MEMBER_GOT_DEMOTED("&cYou have been demoted to %role% in your island."),
    DEMOTED_ISLAND_MEMBER("&aYou have demoted %player% to %role%."),
    DEMOTED_ISLAND_MEMBER_BROADCAST("&c[!] %player% was demoted to %role% by %leader%."),
    CANT_PROMOTE_OR_DEMOTE_ISLAND_MEMBER("&cError: This player cannot be promoted or demoted."),
